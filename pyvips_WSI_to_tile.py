...
def save_tile(tile_name, tile, xpos, ypos, output_dir):
    filename = f'{tile_name}_x0.5__{xpos}_{ypos}.png'
...
def execute_cmdline():
    ...
    parser.add_argument('--ext', help='File extension of input images.', default='.tif')
    parser.add_argument('--scale', help='How much to resize the WSI (0.5x resize is 2x zoom)', default='0.5')
    parser.add_argument('--count', help='Limit of tiles to create before quitting. (Useful for testing)', default='0')
    ...
    for image_filepath in filenames:
        ...
        create_tiles_with_vips(image_filepath, scale, output_dir, t_size, count)
